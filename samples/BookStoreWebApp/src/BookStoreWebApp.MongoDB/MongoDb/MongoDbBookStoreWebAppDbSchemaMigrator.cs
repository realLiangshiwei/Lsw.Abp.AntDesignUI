...
public class MongoDbBookStoreWebAppDbSchemaMigrator : IBookStoreWebAppDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbBookStoreWebAppDbSchemaMigrator(IServiceProvider serviceProvider)
    {
